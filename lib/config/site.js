...
const baseSiteConfig = {
	name: 'Expo Essentials',
	description: 'Expo Essential - Booth Construction',
	url: 'https://www.expoessentials.in/',
	...
	authors: [
		{
			name: 'Abhishek Abbi',
			url: 'https://www.linkedin.com/in/abhishek-abbi/',
		},
	],
	icons: {
		icon: '/favicon.ico',
		shortcut: '/onlylogowhite.png',
		apple: '/onlylogowhite.png',
	}
};
